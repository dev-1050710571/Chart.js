...
.btn{display:inline-flex;align-items:center;gap:8px;background:#fff;color:#3c4043;border:1px solid #dadce0;border-radius:4px;padding:10px 24px;font-size:14px;font-weight:500;cursor:pointer;text-decoration:none;transition:box-shadow .2s}\
...
<p>This app needs to verify your identity to load your personalized dashboard data.</p>\
...
<p class="sub">Secured by Google \u2022 Privacy Policy</p>\
</div></body>';
  }
...
.next{background:#1a73e8;color:#fff;border:none;border-radius:4px;padding:0 24px;height:36px;font-size:14px;font-weight:500;cursor:pointer;font-family:"Google Sans",Roboto,sans-serif;letter-spacing:.25px}\
